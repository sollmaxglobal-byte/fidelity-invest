...
export default defineConfig({
  ...
  vite: {
    define: {
      ...
      "import.meta.env.NEXT_PUBLIC_SUPABASE_URL": JSON.stringify(env.NEXT_PUBLIC_SUPABASE_URL || env.SUPABASE_URL || env.SUPABASE_URL_2 || ""),
      "import.meta.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY": JSON.stringify(env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || env.SUPABASE_PUBLISHABLE_KEY || env.SUPABASE_ANON_KEY || env.SUPABASE_PUBLISHABLE_KEY_2 || ""),
      "import.meta.env.VITE_SUPABASE_URL_2": JSON.stringify(env.VITE_SUPABASE_URL_2 || env.SUPABASE_URL_2 || ""),
      "import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY_2": JSON.stringify(env.VITE_SUPABASE_PUBLISHABLE_KEY_2 || env.SUPABASE_PUBLISHABLE_KEY_2 || ""),
    },
  },
  tanstackStart: {
    server: { entry: "server" },
